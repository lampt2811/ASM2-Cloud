...
<?php
    if (isset($_GET['edit'])) {
		$id = $_GET['edit'];
		$record = pg_query($conn, "SELECT * FROM product WHERE ProductCode=$id");
...
<?php 
    if (isset($_POST['update'])) {
        ...
        pg_query($conn, "UPDATE product SET Name='$updatedName', QtyInStock='$updatedQuantity', Price='$updatedPrice' WHERE ProductCode=$id");
